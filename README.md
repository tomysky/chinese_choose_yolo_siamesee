...
<img src="assets/image-20250529075634030.png" alt="image-20250529075634030" style="zoom:200%;" />

<img src="assets/ff1dc1c706ab48edbc192be8a8578851.png" alt="ff1dc1c706ab48edbc192be8a8578851" style="zoom:200%;" />

> ​		要根据上面的提示的文字顺序，点击下面的对应的文字。还是先做目标检测，把上面的的提示文字和下面的背景文字分别做检测；然后把检测到的文字分割为小图标做分类；最后把检测模型和文字siamese模型组合到一起使用得出结果。
...
<img src="assets/image-20250529080443341.png" alt="image-20250529080443341" style="zoom:200%;" />

> ​	这时候就可以进行siamese训练了，代码如下：
...
> ​	先用yolo检测目标，把检测的图标截取出来，然后用siamese做相似度识别，根据上面提示文字的顺序，把上面每一个文字与下面的每一个文字做相似度对比，对比最高的那个就是同一个分类，同一个分类的文字根据上面的提示文字顶顺序。
